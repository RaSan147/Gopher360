...
void ConfigFile::ExtractKeys()
{
	...
	if (!file)
	{
		...
		outfile << "CURSOR_SPEEDS = ULTRALOW=0.005,LOW=0.015,MED=0.03,HIGH=0.06" << std::endl;
		...
		outfile << "" << std::endl;
		outfile << "" << std::endl;
		outfile << "CONFIG_OSK = 0x0040                 # Toggle on-screen keyboard" << std::endl;
		outfile << "" << std::endl;
		outfile << "" << std::endl;
		...
		outfile << "" << std::endl;
		outfile << "" << std::endl;
		outfile << "CONFIG_MOUSE_LEFT = 0x1000          # Left mouse button          # B" << std::endl;
		outfile << "CONFIG_MOUSE_RIGHT = 0x2000         # Right mouse button         # X" << std::endl;
		...
		outfile << "GAMEPAD_DPAD_RIGHT = 0x27           # RIGHT                      # Right" << std::endl;
		outfile << "GAMEPAD_BACK = 0x5B                 # WINDOW                     # Back/Select" << std::endl;
		outfile << "GAMEPAD_START = 0x09                # TAB                        # Start" << std::endl;
		outfile << "GAMEPAD_RIGHT_THUMB = 0xB3          # MediaPlayPause             # R Thumb Press" << std::endl;
		outfile << "GAMEPAD_LEFT_THUMB = 0              # OnScreenKeyboard           # L Thumb Press" << std::endl;
		outfile << "GAMEPAD_RIGHT_SHOULDER = 0xA7       # Web FORWARD                # Right Trigger" << std::endl;
		outfile << "GAMEPAD_LEFT_SHOULDER = 0xA6        # Web BACKWARD               # Left Trigger" << std::endl;
		outfile << "GAMEPAD_A = 0                       # Default left click         # A" << std::endl;
		outfile << "GAMEPAD_B = 0                       # Default right click        # B" << std::endl;
		outfile << "GAMEPAD_X = 0x0D                    # ENTER                      # X" << std::endl;
		outfile << "GAMEPAD_Y = 0x08                    # BACKSPACE                  # Y" << std::endl;
		outfile << "" << std::endl;
		outfile << "GAMEPAD_TRIGGER_LEFT = 0x10         # shift key                  # L Trigger" << std::endl;
		outfile << "GAMEPAD_TRIGGER_RIGHT = 0x11        # control key                # R Trigger" << std::endl;
		outfile << "GAMEPAD_LEFT_SHOULDER__LT = 0xBD    # ctrl + -                   # LT + LShoulder" << std::endl;
		outfile << "GAMEPAD_RIGHT_SHOULDER__LT = 0xBB   # ctrl + +                   # LT + RShoulder" << std::endl;
		outfile << "GAMEPAD_LEFT_SHOULDER__RT = 0xAE    # Volume Down                # RT + LShoulder" << std::endl;
		outfile << "GAMEPAD_RIGHT_SHOULDER__RT = 0xAF   # Volume Up                  # RT + RShoulder" << std::endl;
		outfile << "" << std::endl;
		// End config dump
