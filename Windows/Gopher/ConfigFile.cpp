...
void ConfigFile::ExtractKeys()
{
	...
	if (!file)
	{
		...
		outfile << "DEAD_ZONE = 2000 # Thumbstick dead zone to use for mouse movement. Absolute maximum thumbstick value is 32768." << std::endl;
		outfile << "SCROLL_DEAD_ZONE = 2000 # Thumbstick dead zone to use for scroll wheel movement. Absolute maximum thumbstick value is 32768." << std::endl;
